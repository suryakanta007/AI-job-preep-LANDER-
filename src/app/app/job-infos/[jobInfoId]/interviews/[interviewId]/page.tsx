...
import { getInterviewIdTag } from "@/fratures/interviews/dbCache"
...
import { generateInterviewFeedback } from "@/fratures/interviews/actions"
...
async function Messages({
  ...
  try {
    ...
    return (
      <div className="max-w-5xl mx-auto p-8 border rounded-lg bg-destructive/10 border-destructive/20">
        <h3 className="text-lg font-semibold text-destructive mb-2">
          Unable to Load Interview Messages
        </h3>
        <p className="text-sm text-muted-foreground">
          The interview messages could not be loaded. The chat may no longer
